...
export const VOWEL_TEAM_PAIRS: VowelPair[] = [
...
export const SOUND_SORT_WORDS: { word: string; sound: "short" | "long" }[] = [
...
export const STRETCH_PAIRS = MAGIC_E_PAIRS.slice(0, 4);
