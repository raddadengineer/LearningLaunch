...
export const level2Words: WordData[] = [
  ...
  { id: 26, word: "STAR", level: 2, imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4", phonics: ["ST", "A", "R"] },
  { id: 27, word: "MOON", level: 2, imageUrl: "https://images.unsplash.com/photo-1446776877081-d282a0f896e2", phonics: ["M", "OO", "N"] },
];
